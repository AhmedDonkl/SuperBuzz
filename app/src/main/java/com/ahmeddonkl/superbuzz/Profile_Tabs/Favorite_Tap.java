 ...
 */
public class Favorite_Tap extends Fragment {

    //list view nad adpater
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.favorite_tab,container,false);


        //link view
        favorite_list = (ListView) v.findViewById(R.id.user_favorite_list);

        //favorite places get user favorite places
        ...
        //set adapter
        favorite_list.setAdapter(place_adapter);
